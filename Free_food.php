        ...
        <div class="container">
            <div class="navbar-inverse">
                ...
                <div class="three panel panel-default">
                    ...
                    <div class="panel-heading"><center><h3>อาหารว่าง</h3></center>
                        <div class="row">
                    ...
                    <div class="three panel-body">
                        <?php
                        $sql = "select * from product where cat_id='5' order by pro_id";
                                        ...
                                        <center>
                                            <div class=" tableproduct1 caption">
                                                ...
                                                <form action='inorder.php' method='post' name='form2' id='form2'>
                                                        ...
                                                        ชุด <select name="number"id="number">
                                                            ...
                                                            <input type="submit" class="btn btn-xs btn-success" name="button" id="button"  value="หยิบใส่ตะกร้า"/></span>
