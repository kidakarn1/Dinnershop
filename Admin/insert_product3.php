        ...
        <div class="container">
            <div class="navbar-inverse">
                ...
                <div class="three panel panel-default ">
                    <center><h3><u>รายชื่อสินค้า เครื่องดื่มปั่น</u></h3></center>
                    <?php
                    $sql1 = "select* from product where cat_id='3'";
                    $res1 = mysqli_query($conn, $sql1);
                    ?>
                    <table class="table table-striped table-condensed table-hover">
                        ...
                        <tr>
                             <td colspan="9" bgcolor="#ffcc66"><center><a href="#frominsertstaff"data-toggle="modal" data-target="#insertproductadmin">เพิ่มข้อมูลสินค้า</a> <a href="insert_product.php">1</a> <a href="insert_product2.php">2</a> <a href="insert_product3.php">3</a> <a href="insert_product4.php">4</a> <a href="insert_product5.php">5</a> <a href="insert_product6.php">6</a></center></td>
                        </tr>
                    </table>
