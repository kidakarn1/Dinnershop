                    ...
                    <form class="form-horizontal" method="post" action="insertfromadmin.php">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
								...
								<input  type="radio"name="status"value="Chef" id="Chef">Chef
								<input  type="radio"name="status"value="Driver" id="Driver">Driver

                            </div>
                        </div>
						 <div class="row">
                                <div class="col-md-offset-4 col-xs-offset-1 col-xs-10 col-md-4">
								<label id="addnew">ทะเบียนรถ<input type="text" name="id_card"id="addnew"></label>
