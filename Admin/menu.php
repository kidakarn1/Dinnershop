                            ...
                            <div class="col-md-12 ">
                                <ul class="nav navbar-nav">
                                    ...
                                    <?php if ($_SESSION[status] == "Admin" or $_SESSION[status] =="Staff") { ?>
                                        ...
                                        <li><a href="total_money.php"><font color="#ffffff">คำนวณเงิน</font></a></li>
										<li><a href="homechef.php"><font color="#ffffff">ราการสั่งซื้อ</font></a></li>
                                        <li><a href="finish_order.php"><font color="#ffffff">รายการสั่งซื้อเสร็จสิ้น</font></a></li>
										 
										  <?php } ?>
		<?php if ($_SESSION[status] == "Admin" or $_SESSION[status] =="Staff") { ?>
                                    
										 <li><a href="car.php"><font color="#ffffff">จัดการการจัดส่ง</font></a></li>
                                   <?php } ?>
<?php if ($_SESSION[status] == "Admin" or $_SESSION[status] =="Staff") { ?>
...
<?php } ?>
            ...
            </nav><?php include("frominsertstaff.php");
?>
            <?php
