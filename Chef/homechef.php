...
if ($_SESSION[user] != "" and $_SESSION[status] == "Chef") {
    ...
    <html lang="en">
        <head>
			...
			<meta http-equiv="refresh" content="10" /><?php // mata แท็ก html เรียวทาม ?>
            ...
            <div class="container">
                <div class="navbar-inverse">
                    ...
                    <div class="three panel panel-default ">
                        ...
                        <?php
                        $spt = 0 + $_GET[sp];
                        $sql5 = "select* from orderdns,product where orderdns.order_status='กำลังดำเนินการจัดทำ' and orderdns.pro_id=product.pro_id order by order_id ASC limit $spt,10";
                                                            ...
                                                            <th colspan="0" bgcolor="#ffcc33"><center>สถานะ</th>
                                                                ...
                                                                <td bgcolor="#ffffff"><center><font color="red"><?php echo $row5[order_status] ?></font></center></td>
                                                                    ...
                                                                    <form method="post" action="edit_orderstatus.php">
                                                                        ...
                                                                        <?php
                                                                        if ($row5[order_status] == 'กำลังดำเนินการจัดทำ') {
                                                                            ?>
                                                                            <input type="hidden" name="order_id"value="<?php echo $row5[order_id] ?>">
                                                                            <input type="submit"value="จัดทำเสร็จสิ้น"name="status">
                                                                            <?php
                                                                        }
                                                                        ?>
                                                                    </form>
